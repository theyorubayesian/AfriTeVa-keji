...
@dataclass
class xQADataArguments(DataArguments):
    """
    ...
    no_answer_string: str = field(default="no answer", metadata={"help": "Label for questions with no answers in the provided context"})
